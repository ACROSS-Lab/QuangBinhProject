...
species unity_linker parent: abstract_unity_linker { 
	...
	init {
		...
		unity_aspect dyke_aspect <- geometry_aspect(40.0, rgb(204, 119, 34, 0.0), precision);
		unity_aspect water_aspect <- geometry_aspect(40.0, rgb(190, 188, 216, 0.0), precision);
